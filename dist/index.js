...
***************************************************************************** */
  ...
  function (e, t, n) {
    ...
    var r,
      i = (r = n(112)) && r.__esModule ? r : { default: r };
    function o(e) {
      return (o =
        'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
          ? function (e) {
  ...
  function (e, t, n) {
    ...
    var r,
      i = (r = n(52)) && r.__esModule ? r : { default: r },
      o = n(124),
      a = n(37),
      u = n(57);
    function s() {
  ...
  function (e, t, n) {
    ...
    var r,
      i = (r = n(86)) && r.__esModule ? r : { default: r };
  },
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function (e, t, n) {
        ...
        const s = (e, t) => {
          ...
          c = (t) => (n, r) => {
            ...
            if ('ids' === r) i = { id: { _in: t.ids } };
              ...
              let [n, o = ''] = r.split('@');
              const a = e.type.fields.find((e) => e.name === n);
              if (a) {
                const e = C(a.type);
                'String' === e.name
                  ? ((o = o || '_ilike'),
                    (i = {
                      [n]: { [o]: o.includes('like') ? `%${t[r]}%` : t[r] },
                    }))
                  : 'OBJECT' === e.kind
                  ? ((o = o || '_eq'), (i = { [n]: s(t[n], o) }))
                  : ((o = o || '_eq'), (i = { [n]: { [o]: t[r] } }));
          ...
          l = Object.keys(i).reduce(c(i), o).filter(Boolean),
          f = Object.keys(u).reduce(c(u), []).filter(Boolean);
        return (
          (r.where = { _and: l, ...(f.length && { _or: f }) }),
          n.pagination &&
        ...
        case 'GET_MANY_REFERENCE':
          ...
          return n.filter
            ? {
                ...i,
                where: {
                  _and: [...i.where._and, { [n.target]: { _eq: n.id } }],
                },
              }
            : { ...i, where: { [n.target]: { _eq: n.id } } };
        case 'GET_MANY':
        case 'DELETE_MANY':
    ...
    const B = (e = {}) =>
      Object.keys(e).reduce((t, n) => {
        ...
        return null == r
          ...
          ? 'object' == typeof r[0]
            ? null != r[0].id
              ? { ...t, [n]: r.map(B), [n + 'Ids']: r.map((e) => e.id) }
              : { ...t, [n]: r.map(B) }
            : { ...t, [n]: r }
          : 'object' == typeof r
          ? { ...t, ...(r && r.id && { [n + '.id']: r.id }), [n]: B(r) }
          : { ...t, [n]: r };
      }, {});
    var Y = (e) => (e, t) => (t) => {
        const n = t.data;
        switch (e) {
          case 'GET_MANY_REFERENCE':
          case 'GET_LIST':
            return { data: n.items.map(B), total: n.total.aggregate.count };
          case 'GET_MANY':
            return { data: n.items.map(B) };
          case 'GET_ONE':
            return { data: B(n.returning[0]) };
          case 'CREATE':
          case 'UPDATE':
          case 'DELETE':
            return { data: B(n.data.returning[0]) };
          case 'UPDATE_MANY':
          case 'DELETE_MANY':
      ...
      $ = n(2);
    const J = (e) =>
      e.kind === Q.TypeKind.NON_NULL ? J(e.ofType) : e.kind === Q.TypeKind.LIST;
    var z = J;
    const W = (e) =>
      e.kind === Q.TypeKind.LIST ? W(e.ofType) : e.kind === Q.TypeKind.NON_NULL;
    var H = W;
    const X = (e) =>
        e.fields.reduce((e, t) => {
          const n = C(t.type);
      ...
      Z = (e) => {
        ...
        return n
          ? r
            ? $.nonNullType(
                $.listType($.nonNullType($.namedType($.name(t.name))))
              )
            : $.nonNullType($.namedType($.name(t.name)))
          : r
          ? $.listType($.namedType($.name(t.name)))
          : $.namedType($.name(t.name));
      },
      ee = (e, t) => {
        ...
        return e.args
          ...
          .reduce(
            (e, t) => [
              ...e,
              $.argument($.name(t.name), $.variable($.name(t.name))),
            ],
            []
          );
      },
      ...
      ne = (e, t) => {
        ...
        return e.args
          ...
          .reduce(
            (e, t) => [
              ...e,
              $.variableDefinition($.variable($.name(t.name)), Z(t)),
            ],
            []
          );
      },
      re = (e, t, n, r, i) => (e, o, a, u) => {
    ...
    var oe = ie(q, (e) => re(e, X, te, ee, ne), Y);
    const ae = {
        introspection: {
          operationNames: {
            GET_LIST: (e) => '' + e.name,
    ...
    t.default = (e, t = {}, n = q, r = Y) => {
      ...
      return L(a()({}, ae, { buildQuery: o }, e)).then((e) => (t, n, r) =>
        e(t, n, r)
      );
    };
  },
